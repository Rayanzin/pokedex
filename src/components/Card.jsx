    ...
    return (
        <>
            <div className="w-[300px]  border-2 border-red-500 flex flex-col rounded-xl shadow-2xl bg-[#333]">
                ...
                <button className="bg-white w-[100px] m-auto p-[10px] rounded-lg font-semibold hover:bg-[#999] duration-300 cursor-pointer active:bg-[#f00] active:text-white " onClick={prop} >Detalhes</button>
            </div>
        </>
      );
}
